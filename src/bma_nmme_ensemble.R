...
{
  file= paste('D:\\干旱\\data\\result8\\nmme_qm_preci_', as.character(num), '.txt', sep='')
  ...
  # all_models_new <- array(all_models_new, dim=c(row, pts))
  file2 = paste('D:\\干旱\\data\\result8\\nmme_bma_', as.character(num), '.txt', sep='')
  ...
  # file2 = paste('D:\\干旱\\data\\result8\\all_models_weight_', as.character(num), '.txt', sep='')
